...
각 블록 Phase A 시작 시, reference 파일 상단의 `📖 공식 문서:` URL을 그대로 전부 출력한다. 참가자가 클릭해서 원문을 볼 수 있어야 한다.
...
| 5 | Memory — CLAUDE.md | `references/block5-memory.md` |
| 6 | 지도 — 7개 기능 | `references/block6-map.md` |
| 7 | 쉬어가기 — 내 터미널 문패 | `references/block7-break.md` |
| 8 | 자기 선언 (Week 1 과제) | `references/block8-declaration.md` |
...
| 4 | 모드 | plan mode 경험 |
| 5 | Memory | CLAUDE.md 시드 |
| 6 | 지도 | 5주 기능 지도 이해 |
| 7 | 쉬어가기 | 나만의 status line |
| 8 | **자기 선언 (과제)** | journey.md 선언 + Slack 제출 |
